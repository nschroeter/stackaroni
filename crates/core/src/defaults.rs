...
///
/// The depth of the Laplacian decomposition: halving stops once the coarsest level
/// reaches this size, so the level count follows the frame rather than being fixed.
